...
export const config: Config = {version: 2, language: 'en', policy: 'balanced', primary: {model: 'model-a', effort: 'high'}, economy: {model: 'model-b', effort: 'medium'}};
export function task() {return taskSchema.parse({id: 'test-task', threadId: 'thread-1', name: 'Test task', cwd: '/tmp', priority: 'medium', mode: 'auto', createdAt: new Date().toISOString()});}
